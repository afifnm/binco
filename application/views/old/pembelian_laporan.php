...
<div class="container mx-auto p-6">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <form method="get" action="<?= base_url('admin/pembelian/laporan'); ?>" class="p-4 bg-gray-200">
        ...
        <table class="min-w-full divide-y divide-gray-200 mt-4">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right"><?= number_format($row['bayar'], 2); ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td></td>
                    <td class="px-6 py-4 text-right font-bold">Rp.<?= number_format($bayar, 2); ?></td>
                    <td></td>
                </tr>
            </tfoot>
        </table>
